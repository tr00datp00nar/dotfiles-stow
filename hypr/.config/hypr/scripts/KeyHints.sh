...
GDK_BACKEND=$BACKEND yad \
  ...
  " M" "Launch Media Player" "(Spotify)" \
  " A" "Desktop Overview" "(AGS - if opted to install)" \
  "CTRL SPACEBAR" "Application Launcher" "(rofi-wayland)" \
  " E" "Open File Manager" "(Nautilus)" \
  " S" "Google Search using rofi" "(rofi)" \
  " Q" "close active window" "(not kill)" \
  " Shift Q" "kills an active window" "(kill)" \
  " CTRL UP/DOWN" "Switch workspace" "" \
  " SHIFT UP/DOWN" "Move active window to prev/next workspace" "" \
  ...
  " ALT H" "Launch this Quick Cheat Sheet" "" \
  "" "" "" \
